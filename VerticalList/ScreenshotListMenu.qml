// gameOS theme
// created by BozoTheGeek 15/09/2023 to manage "screenshots" in vertical list
...
FocusScope {
        ...
        Component {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: theme.text
                    visible: selected && !screenshotview.focus && !headercontainer.focus
    ...
    Keys.onPressed: {
        ...
        if (api.keys.isFilters(event) && !event.isAutoRepeat) {
            ...
            sfxToggle.play();
            softwarelist.focus = false;
            screenshotview.focus = false;
            screenshotViewArea.focus = false;
            headercontainer.focus = true;
            return;
        }
